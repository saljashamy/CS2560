...
/**
 * @file theater_seating.c
 * @author Saif Aljashamy
 * @date 10 April 2019
 * @brief program saves theater seat sales, calculates sales, set seat prices and displays available seats
 *
 * @see https://github.com/saljashamy/CS2560/blob/master/project1
 */
